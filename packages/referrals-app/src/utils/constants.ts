export const defaultTemplateString = (content: string) => {
    ...
    <tr>
    <td align="left" bgcolor="#F8FAFC" style="padding:0;Margin:0;padding-top:20px;padding-left:20px;padding-right:20px;background-color:#f8fafc">
    ...
    </table><!--[if mso]></td><td width="173.33333333333334" valign="top"><![endif]-->
    <table cellpadding="0" cellspacing="0" class="es-left" align="left" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left">
    <tr>
    ...
    </table><!--[if mso]></td><td style="width:20px"></td><td width="173.33333333333334" valign="top"><![endif]-->
    ...
    <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
    <tr>
    <td align="left" style="padding:40px;Margin:0">${content}</td>
    </tr>
    </table></td>
    </tr>
    </table></td>
