...
const jobToMessageMapping: Record<string, string> = {
	...
	[EmailJobType.REFERRAL_REMINDER]: 'Hi ${referrerName}, Here\'s your reminder to refer ${seekerName} to the ${companyName}. Use this link to get quickly refer them: ${referralsLink}. If you need to get in touch, reach ${seekerName} at ${seekerEmail}. Their resume is attached.',
