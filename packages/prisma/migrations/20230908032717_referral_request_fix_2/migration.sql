/*
  ...
  - The values [PENDING] on the enum `ReferralRequestStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ReferralRequestStatus_new" AS ENUM ('COMMITTED', 'ACCEPTED', 'REJECTED', 'OPEN');
